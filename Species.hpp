...
class Species {
private:
    /** @brief The value that indicates the carnivorousness of the species.
     */
    bool carnivorous;

    /** @brief The value that indicates the nutritious minimum of the species.
     */
    int nutritious_minimum;

    /** @brief The value that indicates the nutritious value represented by the species.
     */
    int nutritious_value;

    /** @brief The value that specifies the number of prey animals of the species.
     */
    int nprey;

    /** @brief The vector that contains all the prey animal ids for current species.
     */
    vector<int> prey;
